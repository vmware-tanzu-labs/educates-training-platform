# Generated by Django 3.0.8 on 2021-01-22 01:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_reserved', models.IntegerField(default=0, verbose_name='default reserved')),
                ('default_initial', models.IntegerField(default=0, verbose_name='default initial')),
                ('default_expires', models.IntegerField(default=0, verbose_name='default expires')),
                ('default_orphaned', models.IntegerField(default=0, verbose_name='default orphaned')),
            ],
        ),
        migrations.CreateModel(
            name='Workshop',
