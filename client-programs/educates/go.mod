module github.com/vmware-tanzu-labs/educates-training-platform/client-programs/educates
...
require (
	...
	github.com/vmware-tanzu/carvel-kapp-controller v0.39.0 // indirect
