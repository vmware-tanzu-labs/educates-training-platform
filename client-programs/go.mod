...
require (
	...
	github.com/vmware-tanzu/carvel-kapp-controller v0.40.0 // indirect
...
replace (
	// Copied from https://github.com/docker/compose/blob/v2/go.mod as using latest
	// versions fails as modules have been removed.
