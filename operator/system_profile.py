...
default_portal_image = "$(image_repository)/eduk8s-portal:201021.021827.e806f11"

default_workshop_images = {
    "base-environment:*": "$(image_repository)/base-environment:201025.053558.8eb264e",
    ...
    "jdk8-environment:*": "$(image_repository)/jdk8-environment:201025.054825.53badf2",
    ...
    "jdk11-environment:*": "$(image_repository)/jdk11-environment:201025.054845.79fbcce",
    ...
    "conda-environment:*": "$(image_repository)/conda-environment:201025.054805.b7f4d37",
