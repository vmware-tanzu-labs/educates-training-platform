...
default_portal_image = "$(image_repository)/eduk8s-portal:200729.064453.9fa8ab6"

default_workshop_images = {
    "base-environment:*": "$(image_repository)/base-environment:200729.065116.d64688f",
    ...
    "jdk8-environment:*": "$(image_repository)/jdk8-environment:200729.073011.4f0d6b3",
    ...
    "jdk11-environment:*": "$(image_repository)/jdk11-environment:200729.072954.5481ef8",
    ...
    "conda-environment:*": "$(image_repository)/conda-environment:200729.073328.f5d8eff",
