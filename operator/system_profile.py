...
default_portal_image = "$(image_repository)/eduk8s-portal:200919.023217.9eae94e"

default_workshop_images = {
    "base-environment:*": "$(image_repository)/base-environment:200921.043323.ed97b3a",
    ...
    "jdk8-environment:*": "$(image_repository)/jdk8-environment:200921.045242.d6cc2da",
    ...
    "jdk11-environment:*": "$(image_repository)/jdk11-environment:200921.045301.aed6669",
    ...
    "conda-environment:*": "$(image_repository)/conda-environment:200921.045213.1b31733",
