...
default_portal_image = "$(image_repository)/eduk8s-portal:200908.234032.97a93bf"

default_workshop_images = {
    "base-environment:*": "$(image_repository)/base-environment:200909.031301.7794258",
    ...
    "jdk8-environment:*": "$(image_repository)/jdk8-environment:200909.032947.20fd8c2",
    ...
    "jdk11-environment:*": "$(image_repository)/jdk11-environment:200909.033003.d1a79d8",
    ...
    "conda-environment:*": "$(image_repository)/conda-environment:200909.032910.d7e4806",
