...
default_portal_image = "$(image_repository)/eduk8s-portal:200703.053128.0a7ef30"

default_workshop_images = {
    "base-environment:*": "$(image_repository)/base-environment:200701.050253.4ddbcd6",
    ...
    "jdk8-environment:*": "$(image_repository)/jdk8-environment:200701.051936.0215c68",
    ...
    "jdk11-environment:*": "$(image_repository)/jdk11-environment:200701.051914.7abd512",
    ...
    "conda-environment:*": "$(image_repository)/conda-environment:200701.051958.f85abc4",
