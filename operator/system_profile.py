...
default_portal_image = "$(image_repository)/eduk8s-portal:200729.035511.95b0a4e"

default_workshop_images = {
    "base-environment:*": "$(image_repository)/base-environment:200729.033538.484986c",
    ...
    "jdk8-environment:*": "$(image_repository)/jdk8-environment:200729.040110.483ecc0",
    ...
    "jdk11-environment:*": "$(image_repository)/jdk11-environment:200729.040149.a94ec52",
    ...
    "conda-environment:*": "$(image_repository)/conda-environment:200729.035937.c70785f",
