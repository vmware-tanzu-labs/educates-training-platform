Workshop instructions may at times have you run a command which does not complete immediately, and which will continue to run until interrupted. Click on the sleep command below to setup such a case.
